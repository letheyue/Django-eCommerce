...
STRIPE_SECRET_KEY = os.environ.get("STRIPE_SECRET_KEY", "sk_test_Vsa3Q1q8k6YRX2J600IWWzjl")
STRIPE_PUB_KEY =  os.environ.get("STRIPE_PUB_KEY",'pk_test_zrQeiyEJDcWZZUouU084QErp')
